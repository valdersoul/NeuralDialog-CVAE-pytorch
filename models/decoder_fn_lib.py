...
def train_attention_loop(cell, output_fn, inputs, init_state, context_vector, max_length, atten_fn=None, wc_fn=None):
    return dynamic_rnn_attention(cell, inputs, max_length, init_state, output_fn, atten_fn, context_vector, wc_fn) + (None,)